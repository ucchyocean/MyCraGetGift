...
public class Messages {
    ...
    protected static void initialize(String filename) {
        ...
        File file = new File(MyCraGetGift.pluginDataFolder, filename);
        if ( !file.exists() ) {
            Utility.copyFileFromJar(MyCraGetGift.pluginJarFile,
                    file, filename, false);
        }
    ...
    private static YamlConfiguration loadDefaultMessages() {
        ...
        try {
            jarFile = new JarFile(MyCraGetGift.pluginJarFile);
